...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002161495673"))
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002148911492"))
...
try:
    ADMINS=[1731356432]
    for x in (os.environ.get("ADMINS", "5673859971 6139607609").split()):
        ADMINS.append(int(x))
except ValueError:
